/**
 *Submitted for verification at FtmScan.com on 2021-08-10
*/

// BORGSWAP.Exchange - Ferengi Vaults on FTM
...
contract BSCXToken is ERC20("Ferengi Vaults", "EARS"), Ownable {
    ...
    */
    ...
    constructor() public {
        ...
        _mint(msg.sender, _initial_supply); // Mint bounty program
...
contract BSCXMasterFarmer is Ownable {
    ...
    constructor(
        ...
        lockFromBlock = block.number + 31536000;
        lockToBlock = lockFromBlock + 31536000;
    }
